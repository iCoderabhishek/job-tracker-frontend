  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <div className="bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 rounded-xl p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 max-w-md">
            <input
              ...
              className="flex-1 px-4 py-2 bg-background border border-black/10 dark:border-white/10 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 w-full"
            />
            <button
              onClick={handleRename}
              disabled={isRenaming || !newName.trim()}
              className="flex items-center justify-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg text-sm font-medium hover:bg-primary/90 transition-colors disabled:opacity-50 sm:w-auto w-full"
            >
          ...
          <div className="max-w-md space-y-3">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              <input
                ...
                placeholder="DELETE"
                className="flex-1 px-4 py-2 bg-background border border-red-500/20 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-500/20 text-red-500 w-full"
              />
              <button
                onClick={handleDelete}
                disabled={isDeleting || deleteConfirmName !== "DELETE"}
                className="flex items-center justify-center gap-2 px-4 py-2 bg-red-500 text-white rounded-lg text-sm font-medium hover:bg-red-600 transition-colors disabled:opacity-50 sm:w-auto w-full"
              >
